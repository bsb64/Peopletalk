...
public class DbConnect {
    ...
    private PreparedStatement getFile,getUser,checkUser,insertUser,getSearchUsers,insertMsg,getMsg;
    public DbConnect(){
        try{
 Class.forName("com.mysql.jdbc.Driver");
 con=DriverManager.getConnection("jdbc:mysql://localhost:3306/ptalk","root","");
